...
<div class="container ml-[3.5rem] sm:mx-auto px-5 md:px-10 xl:px-20 overflow-x-hidden"> 
    <h1 class="text-left text-2xl mb-8 sm:text-center font-semibold uppercase mt-16">Categories</h1>
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500">
        ...
        <tbody class="bg-white border-b">
            ...
            <tr class="text-sm">
                <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">{{ $category->id }}</th>
