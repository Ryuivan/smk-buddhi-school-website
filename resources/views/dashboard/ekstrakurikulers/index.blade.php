...
<div class="container ml-[3.5rem] sm:mx-auto px-5 md:px-10 xl:px-20 overflow-x-hidden">
    <h1 class="text-left text-2xl mb-8 sm:text-center font-semibold uppercase mt-16">Extracurricular</h1>    
    ...
    <div class="flex text-left sm:text-center flex-wrap flex-col sm:flex-row sm:justify-between">
        <a href="/dashboard/extracurriculars/create"
            class="transition duration-300 bg-[#315887] hover:bg-[#1C314C] w-48 text-white text-center text-sm px-4 py-2 rounded-md mb-4"> 
